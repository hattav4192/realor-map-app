...
# -*- coding: utf-8 -*-
"""
realor-map-app / Streamlit  ✨デスクトップ版 rev16
...
def main():
    ...
    with st.sidebar:
        ...
        tmin,tmax=st.slider("土地面積(坪)",0,500,(0,500),step=10)
    ...
    cols_order=[
        "所在地","日付","距離(km)","価格(万円)",
        "土地面積(坪)","坪単価(万円/坪)","登録会員","TEL"
    ]
    display=[c for c in cols_order if c in df_flt.columns]
